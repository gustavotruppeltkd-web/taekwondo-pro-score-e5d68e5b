      ...
      {Array.from({ length: totalRounds }, (_, i) => {
        ...
        return (
          <div
            key={i}
            className={cn(
              "w-10 h-10 md:w-14 md:h-14 lg:w-16 lg:h-16 rounded-full flex items-center justify-center",
              "font-bold text-xs md:text-base lg:text-lg transition-all duration-300",
